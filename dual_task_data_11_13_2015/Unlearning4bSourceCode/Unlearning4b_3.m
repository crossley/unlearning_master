function [data] = Unlearning4b_3(debug,condNum)
...
wmSpans=300;  %For Condition 2, there are 200 WM trials.
...
%             sizeflip=0;
            ...
            pause(.2*speedup); %200ms exposure to digit probe stimuli
    ...
    %             circCR=stim(trialNum,5);
            ...
            pause(1*speedup); %1s feedback for line categorization
            Screen(window,'FillRect',black);
%                 pause(.5);
                if dimOrder(wmt)==1
