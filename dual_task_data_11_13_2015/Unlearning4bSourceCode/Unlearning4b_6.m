function [data] = Unlearning4b_1(debug,condNum)
...
wmSpans=300;  %For Condition 1, there are 100 WM trials.
wmTrial=251; %The working memory task goes from trial 251-550
