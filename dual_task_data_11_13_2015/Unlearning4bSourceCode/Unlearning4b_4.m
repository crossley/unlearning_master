function [data] = Unlearning4b_4(debug,condNum)
...
wmSpans=250;  %For Condition 2, there are 200 WM trials.
wmTrial=401; %The working memory task goes from trial 400-650
