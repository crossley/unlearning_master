function [data] = Unlearning4b_2(debug,condNum)
...
wmSpans=200;  %For Condition 2, there are 200 WM trials.
wmTrial=251; %The working memory task goes from trial 250-350
...
%             sizeflip=0;
            ...
            %right now.  Sorry.
%             Screen(window,'FillRect',backcolor);
%             Screen(window,'FillRect',textcolor, [side(1)-50,Yorigin-50, side(1)+50, Yorigin+50]);
%             Screen(window,'FillRect',textcolor, [side(2)-50, Yorigin-50, side(2)+50 Yorigin+50]);
%             Screen(window,'DrawLine',textcolor,X1,Y1,X2,Y2);
