function [mixed_7525m_vars] = generate_mixed_7525m(path, sub_num, block_struct, exclusion_criteria)
...
for i = sub_num
    ...
    data = dlmread([path '/unl7m' num2str(i) '.dat']);
...
mixed_7525m_vars = cell(1,4);
mixed_7525m_vars{1} = learning_curve;
mixed_7525m_vars{2} = std_err_curve;
mixed_7525m_vars{3} = sub_accuracy;
mixed_7525m_vars{4} = excluded_subs;
mixed_7525m_vars{5} = savings_record;
mixed_7525m_vars{6} = intervention_record;
mixed_7525m_vars{7} = mean(accuracy_record);