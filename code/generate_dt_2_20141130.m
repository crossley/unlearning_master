...
for i = sub_num
    ...
    data = dlmread([path '/un4b2' num2str(i) '.txt']);
    ...
    if mean(feedback(201:250)) < exclusion_criteria_acc || mean(dt_feedback(250:450)) < exclusion_criteria_dt
        ...
        dual_task_record = [dual_task_record; mean(dt_feedback(250:450))];
    end
