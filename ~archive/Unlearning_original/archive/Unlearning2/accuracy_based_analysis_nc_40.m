...
ac_II = [1 2 3 4 5 7 8 9 11 13 14 15 17 18 20 21 24];
ac_RB = [6 10 12 19 22 23];

ext_II = [4 14];
ext_RB = [1 2 5 6 8 9 10 11 12 13 19 20 21 22 23];
ext_guess = [3 7 15 17 18 24];

reac_II = [2 3 5 6 7 8 9 12 13 14 15 20 21 22 23];
reac_RB = [1 4 10 11 17 18 19 24];
