...
ac_II = [1:10 16 25:30];
ac_RB = [13 14 18:20 23];

ext_II = [4 9 18 23 27 30];
ext_RB = [1 2 3 6 7 8 13 14 16 19 20 25 28];
ext_guess = [5 10 11 26 29];

% reac_II = [1 3 8 13 14 16 18 23 28 30];
% reac_RB = [2 4 5 6 7 9 10 19 25 26 27];
reac_II = [1:10 14 16 18 19 23 27 28 30];
reac_RB = [13 26];
