...
pooled_ac = [sub_accuracy_75_25(:,1:12); sub_accuracy_40(:,1:12);];
...
( mean(pooled_ac) -  mean(reac_100_rand) ) / std( [pooled_ac; reac_100_rand] )


pooled_ac = [sub_accuracy_100_rand(:,1:12); sub_accuracy_40(:,1:12);];
reac_100_rand = sub_accuracy_100_rand(:,25:36);
reac_75_25 = sub_accuracy_75_25(:,25:36);
reac_40 = sub_accuracy_40(:,25:36);
...
% compute effect sizes for these tests
( mean(pooled_ac) -  mean(reac_75_25) ) / std( [pooled_ac; reac_75_25] )

pooled_ac = [sub_accuracy_100_rand(:,1:12); sub_accuracy_75_25(:,1:12);];
reac_100_rand = sub_accuracy_100_rand(:,25:36);
reac_75_25 = sub_accuracy_75_25(:,25:36);
reac_40 = sub_accuracy_40(:,25:36);
...
% compute effect sizes for these tests
( mean(pooled_ac) -  mean(reac_40) ) / std( [pooled_ac; reac_40] )
...
% % compute effect sizes for these tests
% ( mean(reac_100_rand) -  mean(reac_75_25) ) / std( [reac_100_rand; reac_75_25] )
% ( mean(reac_100_rand) -  mean(reac_40) ) / std( [reac_100_rand; reac_40] )
% ( mean(reac_40) -  mean(reac_75_25) ) / std( [reac_40; reac_75_25] )
...
% % Compute effect sizes for these tests
% (mean(ext_test_75_25) - 0.25) / std(ext_test_75_25)
% (mean(ext_test_75_25_meta) - 0.25) / std(ext_test_75_25_meta)
...
% % Compute effect sizes for these tests
% mean(diff_ac1_ext12) / std(diff_ac1_ext12)
% mean([diff_ac1_ext12_nc; diff_ac1_ext12_nc_meta]) / std([diff_ac1_ext12_nc; diff_ac1_ext12_nc_meta])
...
% % Compute effect sizes for these tests
% (mean(ext_test_40) - 0.25) / std(ext_test_40)
% (mean(ext_test_40_meta) - 0.25) / std(ext_test_40_meta)
