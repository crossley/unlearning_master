...
% plot(ctx_msn_mean_2(1:36), '-k', 'Linewidth', 2, 'color', [0.4 0.4 0.4])
% plot(pf_tan_mean_2(1:36), '--k', 'Linewidth', 2, 'color', [0.4 0.4 0.4])
% plot(ctx_msn_mean_3(1:36), '-k', 'Linewidth', 2, 'color', [0.6 0.6 0.6])
% plot(pf_tan_mean_3(1:36), '--k', 'Linewidth', 2, 'color', [0.6 0.6 0.6])
% axis([0 36+1 0 1])
% set(gca,'XTick',0:2:36, 'fontsize', 10, 'fontweight', 'b')
% axis square
% xlabel('Block', 'fontsize', 18, 'fontweight', 'b')
