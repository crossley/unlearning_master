...
errorbar([1:num_blocks], resp_mean_1, resp_err_1, resp_err_1, '-b', 'LineWidth', 2)
errorbar([1:num_blocks], resp_mean_2, resp_err_2, resp_err_2, '-g', 'LineWidth', 2)
errorbar([1:num_blocks], resp_mean_3, resp_err_3, resp_err_3, '-r', 'LineWidth', 2)
...
% % % % plot(resp_mean_1(1:12), '-k', 'Linewidth', 2)
% % % % plot(resp_mean_1(25:36), '--k', 'Linewidth', 2)
% % % errorbar([0:12], [0.25 resp_mean_3(1:12)], [0 resp_err_3(1:12)], [0 resp_err_3(1:12)], '-k', 'LineWidth', 2)
% % % errorbar([0:12], [resp_mean_3(24) resp_mean_3(25:36)], [resp_err_3(24) resp_err_2(25:36)], [resp_err_3(24) resp_err_2(25:36)], '--k', 'LineWidth', 2)
% % % axis([-0.25 12+1 0 1])
% % % set(gca,'XTick',0:1:12)
% % % axis square
% % % % legend('Acquisition', 'Reacquisition')
...
% plot(resp_mean_1(1:12), '-k', 'Linewidth', 2)
% plot(resp_mean_1(25:36), '--k', 'Linewidth', 2)
errorbar([1:12], [resp_mean_1(1:12)], [resp_err_1(1:12)], [resp_err_1(1:12)], '-k', 'LineWidth', 2)
errorbar([1:12], [resp_mean_1(13:24)], [resp_err_1(13:24)], [resp_err_1(13:24)], '-k', 'LineWidth', 2, 'color', [0.5 0.5 0.5])
errorbar([1:12], [resp_mean_1(25:36)], [resp_err_1(25:36)], [resp_err_1(25:36)], '--k', 'LineWidth', 2)
axis([0 12+1 0 1])
set(gca,'XTick',0:1:12, 'fontsize', 10, 'fontweight', 'b')
axis square
% legend('Acquisition', 'Reacquisition')
...
% plot(resp_mean_1(1:12), '-k', 'Linewidth', 2)
% plot(resp_mean_1(25:36), '--k', 'Linewidth', 2)
errorbar([1:12], [resp_mean_2(1:12)], [resp_err_2(1:12)], [resp_err_2(1:12)], '-k', 'LineWidth', 2)
errorbar([1:12], [resp_mean_2(13:24)], [resp_err_2(13:24)], [resp_err_2(13:24)], '-k', 'LineWidth', 2, 'color', [0.5 0.5 0.5])
errorbar([1:12], [resp_mean_2(25:36)], [resp_err_2(25:36)], [resp_err_2(25:36)], '--k', 'LineWidth', 2)
axis([0 12+1 0 1])
set(gca,'XTick',0:1:12, 'fontsize', 10, 'fontweight', 'b')
axis square
% legend('Acquisition', 'Reacquisition')
...
% plot(resp_mean_1(1:12), '-k', 'Linewidth', 2)
% plot(resp_mean_1(25:36), '--k', 'Linewidth', 2)
errorbar([1:12], [resp_mean_3(1:12)], [resp_err_3(1:12)], [resp_err_3(1:12)], '-k', 'LineWidth', 2)
errorbar([1:12], [resp_mean_3(13:24)], [resp_err_3(13:24)], [resp_err_3(13:24)], '-k', 'LineWidth', 2, 'color', [0.5 0.5 0.5])
errorbar([1:12], [resp_mean_3(25:36)], [resp_err_2(25:36)], [resp_err_2(25:36)], '--k', 'LineWidth', 2)
axis([0 12+1 0 1])
set(gca,'XTick',0:1:12, 'fontsize', 10, 'fontweight', 'b')
axis square
% legend('Acquisition', 'Reacquisition')
