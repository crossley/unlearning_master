...
if figures
    ...
    figure, hold
%     plot(1:num_blocks, acc_cat_mean_1, '-', 'LineWidth', 2, 'color', color(1,:))
%     plot(1:num_blocks, acc_cat_mean_3, '-', 'LineWidth', 2, 'color', color(2,:))
%     plot(1:num_blocks, acc_cat_mean_2, '-', 'LineWidth', 2, 'color', color(3,:))
%     plot(1:num_blocks, acc_cat_mean_4, '-', 'LineWidth', 2, 'color', color(4,:))
%     plot(1:num_blocks-2, acc_cat_mean_5, '-', 'LineWidth', 2, 'color', color(5,:))
    ciplot(acc_cat_mean_1-stdderr_cat_mean_1,acc_cat_mean_1+stdderr_cat_mean_1,1:num_blocks,color(1,:))
    ciplot(acc_cat_mean_2-stdderr_cat_mean_2,acc_cat_mean_2+stdderr_cat_mean_2,1:num_blocks,color(2,:))
    ciplot(acc_cat_mean_3-stdderr_cat_mean_3,acc_cat_mean_3+stdderr_cat_mean_3,1:num_blocks,color(3,:))
    ciplot(acc_cat_mean_4-stdderr_cat_mean_4,acc_cat_mean_4+stdderr_cat_mean_4,1:num_blocks,color(4,:))
    ciplot(acc_cat_mean_5-stdderr_cat_mean_5,acc_cat_mean_5+stdderr_cat_mean_5,1:num_blocks-2,color(5,:))
    camlight; lighting none; 
    alpha(a)
    axis([0 num_blocks+1 0.0 1])
    axis square
    ...
    xlabel('Block', 'fontsize', 18, 'fontweight', 'b')
    set(gca,'XTick',2:2:num_blocks, 'fontsize', 12, 'fontweight', 'b')
%     legend({'Condition 1', 'Condition 2', 'Condition 3', 'Condition 4', 'Condition 5'}, 'fontsize', 18, 'Location', 'North');
%     legend boxoff
    plot([12,12],[0 1],'--k', 'LineWidth', 2)
    plot([28,28],[0 1],'--k', 'LineWidth', 2)
...
%     title('Between-Condition Savings','fontsize', 18, 'fontweight', 'b')
    ...
    %% Savings
%     % Savings - read these out from the MixMod package for R - lsmeansTAB
%     lower_1 = -0.0399; upper_1 = 0.0357; CI_1 = (upper_1-lower_1)/2; mean_1 = upper_1 - (upper_1 - lower_1)/2;
%     lower_2 = -0.0561; upper_2 = 0.0253; CI_2 = (upper_2-lower_2)/2; mean_2 = upper_2 - (upper_2 - lower_2)/2;
%     lower_3 = 0.0076; upper_3 = 0.0851; CI_3 = (upper_3-lower_3)/2; mean_3 = upper_3 - (upper_3 - lower_3)/2;
%     lower_4 = -0.0807; upper_4 = 0.0029; CI_4 = (upper_4-lower_4)/2; mean_4 = upper_4 - (upper_4 - lower_4)/2;
%     
%     mean_1 = -mean_1;
%     mean_2 = -mean_2;
%     mean_3 = -mean_3;
...
%     set(gca,'XTickLabel',{'1','2','3','4'},'fontsize', 16, 'fontweight', 'b')
%     axis square
%     title('Savings: Recquisition-Acquisition','fontsize', 18, 'fontweight', 'b')
    
    %% savings matlab style    
    cond_1_savings = mean(sub_accuracy_1(:,1:4),2) - mean(sub_accuracy_1(:,29:32),2);
    cond_2_savings = mean(sub_accuracy_2(:,1:4),2) - mean(sub_accuracy_2(:,29:32),2);
    cond_3_savings = mean(sub_accuracy_3(:,1:4),2) - mean(sub_accuracy_3(:,29:32),2);
    cond_4_savings = mean(sub_accuracy_4(:,1:4),2) - mean(sub_accuracy_4(:,29:32),2);
    cond_5_savings = mean(sub_accuracy_5(:,1:4),2) - mean(sub_accuracy_5(:,29:32),2);
    
    % we want reac-ac so add negative sign because I did the opposite above
    ...
    errorbar(1, mean_1, CI_1, '*k', 'linewidth',2, 'color', color(1,:))
    errorbar(2, mean_2, CI_2, '*k', 'linewidth',2, 'color', color(2,:))
    errorbar(3, mean_3, CI_3, '*k', 'linewidth',2, 'color', color(3,:))
    errorbar(4, mean_4, CI_4, '*k', 'linewidth',2, 'color', color(4,:))
    errorbar(5, mean_5, CI_5, '*k', 'linewidth',2, 'color', color(5,:))
    ylabel('Accuracy Difference', 'fontsize', 18, 'fontweight', 'b')
    xlabel('Condition', 'fontsize', 18, 'fontweight', 'b')
    ...
    %% savings matlab style 2 
    cond_1_savings = (mean(sub_accuracy_1(:,30),2)-mean(sub_accuracy_1(:,29),2)) - (mean(sub_accuracy_1(:,2),2)-mean(sub_accuracy_1(:,1),2));
    cond_2_savings = (mean(sub_accuracy_2(:,30),2)-mean(sub_accuracy_2(:,29),2)) - (mean(sub_accuracy_2(:,2),2)-mean(sub_accuracy_2(:,1),2));
    cond_3_savings = (mean(sub_accuracy_3(:,30),2)-mean(sub_accuracy_3(:,29),2)) - (mean(sub_accuracy_3(:,2),2)-mean(sub_accuracy_3(:,1),2));
    cond_4_savings = (mean(sub_accuracy_4(:,30),2)-mean(sub_accuracy_4(:,29),2)) - (mean(sub_accuracy_4(:,2),2)-mean(sub_accuracy_4(:,1),2));
    cond_5_savings = (mean(sub_accuracy_5(:,30),2)-mean(sub_accuracy_5(:,29),2)) - (mean(sub_accuracy_5(:,2),2)-mean(sub_accuracy_5(:,1),2));
...
%     fid_all = fopen('anova_savings','w');
%     fprintf(fid_all, 'condition phase block subject accuracy\n');
%     fprintf(fid_all,'%f %f %f %f %f\n',[anova_savings_1; anova_savings_2; anova_savings_3; anova_savings_4; anova_savings_5;]');
%     fclose(fid_all);
    
%     fid_all = fopen('anova_ac','w');
%     fprintf(fid_all, 'condition phase block subject accuracy\n');
%     fprintf(fid_all,'%f %f %f %f %f\n',[anova_ac_1; anova_ac_2; anova_ac_3; anova_ac_4; anova_5;]');
%     fclose(fid_all);
%     
%     fid_all = fopen('anova_ext','w');
%     fprintf(fid_all, 'condition phase block subject accuracy\n');
%     fprintf(fid_all,'%f %f %f %f %f\n',[anova_ext_1; anova_ext_2; anova_ext_3; anova_ext_4; anova_5;]');
%     fclose(fid_all);
%     
%     fid_all = fopen('anova_reac','w');
%     fprintf(fid_all, 'condition phase block subject accuracy\n');
%     fprintf(fid_all,'%f %f %f %f %f\n',[anova_reac_1; anova_reac_2; anova_reac_3; anova_reac_4; anova_5;]');
%     fclose(fid_all);
%     
%     block = anova_1(:,3);
%     exclude_ind = find(block>6 & block<13);
%     anova_1(exclude_ind,:) = [];
%     
%     block = anova_2(:,3);
%     exclude_ind = find(block>6 & block<13);
...
%     anova_4(exclude_ind,:) = [];
% 
%     fid_1 = fopen('anova_1','w');
%     fid_2 = fopen('anova_2','w');
%     fid_3 = fopen('anova_3','w');
%     fid_4 = fopen('anova_4','w');
%     fprintf(fid_1, 'condition phase block subject accuracy\n');
%     fprintf(fid_2, 'condition phase block subject accuracy\n');
%     fprintf(fid_3, 'condition phase block subject accuracy\n');
%     fprintf(fid_4, 'condition phase block subject accuracy\n');
%     fprintf(fid_1,'%f %f %f %f %f\n',anova_1');
%     fprintf(fid_2,'%f %f %f %f %f\n',anova_2');
%     fprintf(fid_3,'%f %f %f %f %f\n',anova_3');
%     fprintf(fid_4,'%f %f %f %f %f\n',anova_4');
%     fclose(fid_1);
%     fclose(fid_2);
%     fclose(fid_3);
%     fclose(fid_4);
% 
%     anova_savings_1 = [anova_ac_1(1:size(anova_reac_1,1),1:end-1) anova_reac_1(:,end)-anova_ac_1(1:size(anova_reac_1,1),end)];
%     anova_savings_2 = [anova_ac_2(1:size(anova_reac_2,1),1:end-1) anova_reac_2(:,end)-anova_ac_2(1:size(anova_reac_2,1),end)];
%     anova_savings_3 = [anova_ac_3(1:size(anova_reac_3,1),1:end-1) anova_reac_3(:,end)-anova_ac_3(1:size(anova_reac_3,1),end)];
%     anova_savings_4 = [anova_ac_4(1:size(anova_reac_4,1),1:end-1) anova_reac_4(:,end)-anova_ac_4(1:size(anova_reac_4,1),end)];
%     anova_savings_5 = [anova_ac_5(1:size(anova_reac_5,1),1:end-1) anova_reac_5(:,end)-anova_ac_5(1:size(anova_reac_5,1),end)];
% 
%     fid_all = fopen('anova_savings','w');
%     fprintf(fid_all, 'condition phase block subject accuracy\n');
%     fprintf(fid_all,'%f %f %f %f %f\n',[anova_savings_1; anova_savings_2; anova_savings_3; anova_savings_4; anova_savings_5;]');
